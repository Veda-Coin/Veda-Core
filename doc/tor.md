...
It is possible to run Veda Core as a Tor hidden service, and connect to such services.
...
1. Run Veda Core behind a Tor proxy
----------------------------------

The first step is running Veda Core behind a Tor proxy. This will already make all
...
port 31995 and only allows .onion nodes to connect:
	...
	./vedad -onion=127.0.0.1:31995 -onlynet=tor -listen=0 -addnode=ssapp53tmftyjmjb.onion

In a typical situation, this suffices to run behind a Tor proxy:

	./vedad -proxy=127.0.0.1:31995


2. Run a Veda Core hidden server
-------------------------------
...
your vedad's P2P listen port (21966 by default).
	...
	-externalip=X   You can tell Veda Core about its publicly reachable address using
	                ...
	                /var/lib/tor/vedacore-service/hostname. Onion addresses are given
...
In a typical situation, where you're only reachable via Tor, this should suffice:
	...
	./vedad -proxy=127.0.0.1:31995 -externalip=ssapp53tmftyjmjb.onion -listen

(obviously, replace the Onion address with your own). It should be noted that you still
listen on all devices and another node could establish a clearnet connection, when knowing
your address. To mitigate this, additionally bind the address of your Tor proxy:

	./vedad ... -bind=127.0.0.1
...
for normal IPv4/IPv6 communication, use:
	...
	./vedad -onion=127.0.0.1:31995 -externalip=ssapp53tmftyjmjb.onion -discover


3. List of known Veda Core Tor relays
------------------------------------
...
Veda Core has been updated to make use of this.

This means that if Tor is running (and proper authorization is available),
Veda Core automatically creates a hidden service to listen on, without
manual configuration. This will positively affect the number of available
.onion nodes.

This new feature is enabled by default if Veda Core is listening, and
