...
Veda Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 21966.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 21968 for connections and services them.
...
However, in open source software such as Veda Core, where everyone uses
...
pay attention to for reviewers of Veda Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Veda Core uses tinyformat, which is type safe. Leave them out to avoid confusion
